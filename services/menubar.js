...
/*
	TOOD:
		...
		- make less abstract. Make args constants
		- remove unused features. expose more inner api's
*/
...
module.exports = function create (opts) {
  ...
  if (!opts.index) {
		...
		opts.index = 'file://' + path.join(opts.dir, opts.index)
	}
  ...
  function appReady () {
    ...
    if (!fs.existsSync(iconPath)) throw "Missing file icon."
